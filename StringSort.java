package assignment_7b;  //This java file is inside package named package1 inside src folder.
...
public class StringSort    //Class declaration containing main function. 
{
	...
	{
		String mainString="I am working as an Software Engineer in an IT Firm";    //Generated the String to sort the data as asked in the problem statement.
		
		System.out.println("I am working as an Software Engineer in an IT Firm\n");
